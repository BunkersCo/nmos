...
| [Sony nmos-cpp](https://github.com/sony/nmos-cpp) | C++  | Apache 2.0 | IS-04, IS-05, IS-07, IS-08, IS-09 API implementations, BCP-003-01 support, cross-platform registry and node applications |
...
| Nextera Video | [NMOS Software Core](http://www.nexteravideo.com/nmos) | IS-04 v1.3 <br/> IS-05 v1.1 <br/> IS-08 v1.0 | Software core for FPGA embedded or standalone processor |
